...
**두 1층은 겹치지 않음** — 실측 380건에서 같은 줄을 둘 다 지적한 것이 5줄
...
| **주의** · 참고 | 절단형 의심 130 · 해설을 인용으로 49 · 반복 블록 라벨 불일치 45 · 형식 미표기 43 · 평가 수식어 25 · 번역투 12 · 지어낸 명사구 0 |

*문서 890건 기준 · 2026-09-03*
...
| `tests/` | 시험 파일 33개 · 배포본을 망가뜨리면 여기서 실패 |
| `runs/` | 실행 기록 23건 · 입력·결과·판정 |
...
**1단계가 지적의 대부분을 냄** · 진행 상태와 남은 다듬을 곳은 [현재 상태](status.md)의 「부서원 공유」

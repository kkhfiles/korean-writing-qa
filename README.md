...
**한국어 업무 문서 검사기** — 사내 보고서 600여 개 실측 · 형식과 무관한 오류가 있던 문서 8% · 개조식 규약까지 켜면 33% · 받아서 그대로 쓸 수 있음
...
**건너뛰기 14건이 정상인 까닭** — 작성자 기계에만 있는 연구 자료(사내 문서 복사본)를 대조하는 시험이다. 검사기와 스킬을 재는 시험은 전부 돈다.
